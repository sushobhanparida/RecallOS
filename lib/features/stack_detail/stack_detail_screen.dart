...
class _StackDetailViewState extends ConsumerState<_StackDetailView> {
  ...
  Future<void> _onShareTap() async {
    ...
    try {
      ...
      // Reload so sharedId is reflected in icon color
              ...
              children: [
                ...
                if (_sharing)
                  ...
                  IconButton(
                    ...
                    tooltip: stack.isShared ? 'Shared — tap to manage' : 'Share',
                  ),
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return _GridItem(
                        ...
                        onRemove: () => widget.onRemoveScreenshot(s.id!),
                      );
                    },
                  ),
          ),
...
class _ShareSheet extends StatelessWidget {
  ...
  const _ShareSheet({required this.url, required this.onUnshare});
